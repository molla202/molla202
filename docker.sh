...
sleep 1 && curl -s https://raw.githubusercontent.com/molla202/Scripts/refs/heads/main/core-node.sh | bash && sleep 1
sleep 2
...
echo "=================================================="
echo -e "\e[1m\e[32m5. Installation is complete \e[0m" && sleep 1
